    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => NotificationDetailScreen(
          ...
          fotoFile: _fotoFile,
          service: _service!,
          historyItem: historyItem, // ◄ SEKARANG DIKIRIM
        ),
      ),
    );
  }
      ...
      onTap: () async {
        ...
        final result = await showMenu<String>(
          ...
          position: RelativeRect.fromLTRB(offset.dx,
              offset.dy + size.height + 4, offset.dx + size.width, 0),
          shape:
            ...
            child: Row(
              children: [
                ...
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: _sudahAman
                        ? _C.waspadaText.withOpacity(0.9)
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: Text(
                      widget.historyItem != null
                          ? 'Lihat di Riwayat' // ◄ teks berubah kalau ada historyItem
                          : 'Lihat Riwayat',
                      style: const TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
